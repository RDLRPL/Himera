...
if param == "CLEAR":
    try:
        os.remove("Shaders.bin")
    except FileNotFoundError:
        print("Not Found DEV_SHADERS. Removed DEV_SHADERS")

    try:
        shutil.rmtree("build")
    except FileNotFoundError:
        print("Not Found BUILD. Removed build")